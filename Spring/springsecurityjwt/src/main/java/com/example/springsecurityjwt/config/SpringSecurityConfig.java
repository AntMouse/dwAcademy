...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers("index.html", "/History", "/Tyrannosaurus", "/Mosasaurus", "/Spinosaurus", "/Triceratops","/Pteranodon", "/Employee","/img/**", "/api/login", "/api/signup", "/signup", "/login","login.js", "login.css", "Add.css", "data.css", "Employee.css", "header.css", "history.css", "main.css", "management.css", "myInfo.css", "scroll.css", "scroll.js", "signup.css", "/visitorCount").permitAll()
