...
public class DataInitializer implements CommandLineRunner {
    ...
    @Autowired
    private ProductTypeRepository productTypeRepository; // ProductType 저장소 추가
    ...
    public void run(String... args) throws Exception {
        ...
        for (ProductTypeEnum type : types) {
            for (int i = 1; i <= 3; i++) {
                Product product = Product.builder()
                        .productType(new ProductType(type, type.getMajorType()))
        ...
        // ProductType 저장
        productTypeRepository.saveAll(List.of(ProductTypeEnum.values()));
