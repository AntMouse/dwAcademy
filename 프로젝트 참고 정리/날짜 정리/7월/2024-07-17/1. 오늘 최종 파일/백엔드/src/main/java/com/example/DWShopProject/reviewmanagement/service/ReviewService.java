package com.example.DWShopProject.reviewmanagement.service;

import com.example.DWShopProject.reviewmanagement.dto.ReviewDto;
...
import com.example.DWShopProject.reviewmanagement.repository.ReviewRepository;
...
public class ReviewService {
    ...
    public ReviewDto updateReview(Long id, ReviewDto reviewDto, String username) {
        ...
        Review review = reviewRepository.findByIdAndUserId(id, userRepository.findByAccountId(username).orElseThrow(() -> new ResourceNotFoundException("회원을 찾을 수 없습니다.")).getId())
