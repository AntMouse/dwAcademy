...
public class ReviewService {
    ...
    // 리뷰 생성 메서드
    public ReviewDto createReview(ReviewDto reviewDto, String fullName) {
    ...
    // 리뷰 업데이트 메서드
    public ReviewDto updateReview(Long id, ReviewDto reviewDto, String fullName) {
        logger.info("Updating review with ID: {}", id);

        Review review = reviewRepository.findByIdAndUserId(id, userRepository.findByUsername(fullName).orElseThrow(() -> new ResourceNotFoundException("회원을 찾을 수 없습니다.")).getId())
    ...
    // 리뷰 삭제 메서드
    public void deleteReview(Long id, String fullName) {
