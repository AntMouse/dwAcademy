package com.example.DWShopProject.admin.orderadmin.controller;
...
public class AOrderController {
    ...
    private final com.example.DWShopProject.admin.orderadmin.service.AOrderService AOrderService;

    @Autowired
    public AOrderController(com.example.DWShopProject.admin.orderadmin.service.AOrderService AOrderService) {
