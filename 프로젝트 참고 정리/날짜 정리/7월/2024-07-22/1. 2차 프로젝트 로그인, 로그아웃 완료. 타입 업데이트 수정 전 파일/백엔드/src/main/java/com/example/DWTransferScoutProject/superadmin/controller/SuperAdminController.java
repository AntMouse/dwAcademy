...
public class SuperAdminController {
    ...
    public ResponseEntity<UserDto> updateUserType(@PathVariable Long userId, @RequestBody Map<String, String> payload) {
        String accountTypeString = payload.get("accountType");
        ApplicationRoleEnum accountType = ApplicationRoleEnum.fromString(accountTypeString);
        return ResponseEntity.ok(adminService.updateUserType(userId, accountType));
    }
}
