...
public class User {
    ...
    // 생성자&메서드
    public User(String username, String password, String email, Set<UserRole> roles, String fullName,
                Gender gender, String birthdate, String contact, boolean isMarketingOptIn) {
    ...
    public void updateUserProfile(String email, String fullName, Gender gender, String birthdate, String contact) {
