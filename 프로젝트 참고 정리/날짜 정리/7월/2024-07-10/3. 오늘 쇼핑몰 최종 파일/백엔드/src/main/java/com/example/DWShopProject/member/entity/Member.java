...
public class Member {
    ...
    @Builder
    public Member(MemberRole memberType, String memberId, String memberName, String password,
    ...
    public void updateMemberType(MemberRole memberType) {
        if (memberType != null) {
            this.memberType = memberType;
        }
    }

    public Member(Long id, MemberRole memberType, String memberId, String memberName, String password, String birthdate, String gender, String email, String contact) {
        this.id = id;
        this.memberType = memberType;
        this.memberId = memberId;
        this.memberName = memberName;
