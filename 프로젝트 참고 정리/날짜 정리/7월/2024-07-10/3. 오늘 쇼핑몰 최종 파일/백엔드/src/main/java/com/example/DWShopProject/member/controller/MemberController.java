...
import com.example.DWShopProject.common.constants.Constants;
import com.example.DWShopProject.common.exception.ResourceNotFoundException;
import com.example.DWShopProject.common.dto.LoginDto;
...
import com.example.DWShopProject.security.userdetails.MemberDetailsImpl;
    ...
    public ResponseEntity<?> signUp(@RequestBody MemberDto memberDto) {
        ...
        try {
            if (optionalMember.isPresent()) {
                ...
                return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("하나의 이메일에 " + Constants.MAX_EMAIL_ASSOCIATED_ACCOUNTS + "개의 아이디만 만들 수 있습니다.");
            }
