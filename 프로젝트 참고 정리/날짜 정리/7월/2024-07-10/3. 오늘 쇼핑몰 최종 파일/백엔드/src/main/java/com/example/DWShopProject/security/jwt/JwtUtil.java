package com.example.DWShopProject.security.jwt;


import com.example.DWShopProject.security.enums.MemberRole;
import com.example.DWShopProject.security.userdetails.MemberDetailsServiceImpl;
...
public class JwtUtil {
    ...
    // 토큰 생성
    public String createToken(String memberId, MemberRole memberType) {
        Date date = new Date();
