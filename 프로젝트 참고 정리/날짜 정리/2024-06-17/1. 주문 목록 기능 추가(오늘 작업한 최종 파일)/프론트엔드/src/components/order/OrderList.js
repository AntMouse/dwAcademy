        ...
        <tr>
          ...
          <th style={{ width: '10%' }}>
            <div className="order-list-column-header">
              <span>주문번호</span>
              <div className="order-list-sort-buttons">
                <button onClick={() => handleSortChange('id', 'asc')}>▲</button>
                <button onClick={() => handleSortChange('id', 'desc')}>▼</button>
              </div>
            </div>
          </th>
          <th style={{ width: '30%' }}>
            <div className="order-list-column-header">
              <span>상품명</span>
              <div className="order-list-sort-buttons">
                <button onClick={() => handleSortChange('productName', 'asc')}>▲</button>
                <button onClick={() => handleSortChange('productName', 'desc')}>▼</button>
              </div>
            </div>
          </th>
          <th style={{ width: '15%' }}>
            <div className="order-list-column-header">
              <span>총가격</span>
              <div className="order-list-sort-buttons">
                <button onClick={() => handleSortChange('totalPrice', 'asc')}>▲</button>
                <button onClick={() => handleSortChange('totalPrice', 'desc')}>▼</button>
              </div>
            </div>
          </th>
          <th style={{ width: '20%' }}>
            <div className="order-list-column-header">
              <span>주문상태</span>
              <div className="order-list-sort-buttons">
                <button onClick={() => handleSortChange('status', 'asc')}>▲</button>
                <button onClick={() => handleSortChange('status', 'desc')}>▼</button>
              </div>
            </div>
          </th>
