...
const Login = ({setUserType}) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://1.226.84.83:8080/api/login', formData)
            .then(Response => {
                ...
                axios.get('http://1.226.84.83:8080/api/user/type', {
                    headers: {
                        'Authorization': token
                    }
                })
        ...
        <div class="login-wrapper">
            <div className="login-container">
                ...
                <form onSubmit={handleSubmit} className="login-form">
                    ...
                    <button className='signup-buttons'>아이디찾기</button>
                    <button className='signup-buttons'>비밀번호찾기</button>
