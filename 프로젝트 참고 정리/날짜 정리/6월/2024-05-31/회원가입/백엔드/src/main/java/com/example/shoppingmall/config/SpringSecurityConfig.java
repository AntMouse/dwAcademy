    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/signup", "signup/**", "/api/members", "api/login","/**").permitAll()
                        .requestMatchers("/mypage","login.js").authenticated() // 모든 로그인한 사용자에게 허용
                        .requestMatchers("/members").hasRole(MemberRoleEnum.ADMIN.toString()) // ADMIN만 허용
