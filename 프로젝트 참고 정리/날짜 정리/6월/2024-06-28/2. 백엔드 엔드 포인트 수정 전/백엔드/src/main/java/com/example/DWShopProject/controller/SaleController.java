...
public class SaleController {
    ...
    // 6-3. 상품별 기간 매출
    /**
     * 특정 기간 동안의 각 상품별 매출 금액을 반환합니다.
     * 쿼리 매개변수로 startDate와 endDate를 제공해야 합니다.
     * 예: /api/sales/product-sales?startDate=2023-01-01T00:00:00&endDate=2023-12-31T23:59:59
     *
     * @param startDate 조회 시작 날짜와 시간
     * @param endDate 조회 종료 날짜와 시간
    ...
    public List<Map<String, Object>> getProductSalesByPeriod(@RequestParam LocalDateTime startDate, @RequestParam LocalDateTime endDate) {
        return saleService.getProductSalesByPeriod(startDate, endDate);
    }

    // 6-4. 상품 타입별 기간 매출
    /**
     * 특정 기간 동안의 각 상품 타입별 매출 금액을 반환합니다.
     * 쿼리 매개변수로 startDate와 endDate를 제공해야 합니다.
     * 예: /api/sales/product-type-sales?startDate=2023-01-01T00:00:00&endDate=2023-12-31T23:59:59
     *
     * @param startDate 조회 시작 날짜와 시간
     * @param endDate 조회 종료 날짜와 시간
     * @return 각 상품 타입별 매출 금액을 포함하는 리스트
     */
    @GetMapping("/product-type-sales-period")
    public List<Map<String, Object>> getProductTypeSalesByPeriod(@RequestParam LocalDateTime startDate, @RequestParam LocalDateTime endDate) {
        return saleService.getProductTypeSalesByPeriod(startDate, endDate);
    }
}