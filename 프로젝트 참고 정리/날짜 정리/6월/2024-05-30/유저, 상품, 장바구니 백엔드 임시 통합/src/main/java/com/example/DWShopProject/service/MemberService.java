...
//        if (!passwordEncoder.matches(loginDAO.getPassword(), member.getPassword())) {
//
//            throw new IllegalArgumentException("비밀번호가 일치하지 않습니다.");
//        }

        Cookie cookie = new Cookie(JwtUtil.AUTHORIZATION_HEADER, jwtUtil.createToken(member.getMemberId(), member.getMemberType()));
