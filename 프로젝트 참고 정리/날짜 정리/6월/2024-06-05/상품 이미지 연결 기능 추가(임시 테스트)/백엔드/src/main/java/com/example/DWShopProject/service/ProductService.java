...
public class ProductService {
    ...
    public ProductDto createProduct(ProductDto productDTO) {
        Product product = Product.builder()
                ...
                .productImgUrl(productDTO.getProductImgUrl()) // 이미지 URL 필드 추가
    ...
    public ProductDto updateProduct(Long id, ProductDto productDTO) {
        ...
        product.updateProductInfo(productDTO.getProductType(), productDTO.getProductName(),
                productDTO.getPrice(), productDTO.getExplanation(), productDTO.getProductImgUrl()); // 이미지 URL 필드 추가
    ...
    private ProductDto mapToDTO(Product product) {
        return ProductDto.builder()
                ...
                .productImgUrl(product.getProductImgUrl()) // 이미지 URL 필드 추가
                .build();
    }
}
