...
public enum ProductTypeEnum {
    ...
    KNIT_SWEATERS("니트/스웨터", ParentTypeEnum.TOPS),
    COLLAR_TSHIRTS("카라티셔츠", ParentTypeEnum.TOPS),
    SWEATSHIRTS("맨투맨", ParentTypeEnum.TOPS),
    SHIRTS_BLOUSES("셔츠/블라우스", ParentTypeEnum.TOPS),
    ...
    SUIT_SLACKS("슈트/슬랙스", ParentTypeEnum.BOTTOMS),
    ...
    RINGS_BRACELETS("반지/팔찌", ParentTypeEnum.ACCESSORIES),
    NECKLACES("목걸이", ParentTypeEnum.ACCESSORIES),
    EARRINGS("귀걸이", ParentTypeEnum.ACCESSORIES),
    SUNGLASSES_GLASSES("선글라스/안경", ParentTypeEnum.ACCESSORIES),
